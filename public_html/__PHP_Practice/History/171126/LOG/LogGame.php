...
foreach($LogChunk as $cnt)
{
	...
	$Query = "INSERT DELAYED INTO {$TableName} (date, accountno, logtype, logcode, param1, param2, param3, param4, paramstring) VALUES (NOW(), '{$AccountNo}', {$LogType}, {$LogCode}, {$Param1}, {$Param2}, {$Param3}, {$Param4}, '{$ParamString}')";
